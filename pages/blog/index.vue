...
useSeoMeta({
  title: 'Blog · Chairasta',
  description: 'All posts from Chairasta — recipes, ritual, and stories from the chai trail.',
})
</script>
...
<template>
  <div>
    <div class="mb-10 text-center">
      <h2 class="text-3xl font-serif font-bold text-chai-800 mb-2">Blog</h2>
      <p class="text-chai-600 text-lg">Every post, steeped and ready.</p>
    </div>
